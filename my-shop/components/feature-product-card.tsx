...
export const FeatureProductCard = ({src, brand, name, price}: FeatureProductCardProps) => {
    return(
        <div className="w-[23%] min-w-[250px] py-[10px] px-3 border border-[#cce7d0] rounded-[25px] cursor-pointer shadow-xl mx-0 my-[15px] hover:shadow-2xl transition relative">
            ...
            <div className="text-start py-[10px] px-0">
                <span className="text-[#606063] text-xs">
                    {brand}
                </span>
                <h5 className="pt-[7px] text-[14px] text-neutral-700">
                   {name}
                </h5>
                <div>
                    <Stars />
