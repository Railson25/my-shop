...
export const Newsletter = () => {
  return (
    <div className="flex justify-between items-center flex-wrap bg-[url('/images/banner/b14.png')] bg-no-repeat bg-[20%] bg-[#041e42]  py-10 px-20 my-10 ">
      <div>
      ...
      <div className="flex w-[40%] max-md:w-[70%]">
        <input
