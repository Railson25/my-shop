...
export const Input = ({ id, label, onChange, value, type }: InputProps) => {
  return (
    <div className="relative">
      <input
        ...
        type={type}
        value={value}
        className="block rounded-md px-6 pt-6 pb-1 w-full text-md text-white border border-solid border-[#e1e1e1e] appearance-none focus:outline-none focus:ring-0 peer "
        placeholder=" "
      />
      <label
